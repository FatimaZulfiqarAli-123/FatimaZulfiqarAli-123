...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1500&color=58A6FF&center=true&vCenter=true&width=750&lines=Hey+there!+I'm+Fatima+%F0%9F%91%8B)](https://git.io/typing-svg)
...
[![LeetCode](https://img.shields.io/badge/LeetCode-FFA116?style=for-the-badge&logo=leetcode&logoColor=black)](https://leetcode.com/u/FatimaZulfiqarAli/)
[![Hugging Face](https://img.shields.io/badge/Hugging%20Face-FFD21E?style=for-the-badge&logo=huggingface&logoColor=black)](https://huggingface.co/fatymahaly)
...
| **Multilingual NLP** | Cross-Lingual & Multilingual Language Processing |
...
**Evaluating Dialectal and Stereotypical Bias in Arabic Large Language Models**

- 🔬 Arabic LLM bias evaluation
- ⚖️ Dialectal and stereotypical bias
- 📊 Multi-component evaluation metrics
- 📝 Research-oriented NLP project

[View Repository →](https://github.com/FatimaZulfiqarAli-123/AraRegBias)
...
**Arabic Pre-trained Language Models for Sentiment Analysis**
...
[View Repository →](https://github.com/FatimaZulfiqarAli-123/Cross_Dialect_Robustnes)
...
- 💬 Question Answering
- 📊 Confidence scoring
- 🛡️ LLM reliability and hallucination mitigation

[View Repository →](https://github.com/FatimaZulfiqarAli-123/RAG_Hallucination_Project)
...
- 🧠 Logistic Regression
- 🌍 Gulf, Egyptian, Levantine & Maghrebi dialects
- 🖥️ Streamlit interface

[View Repository →](https://github.com/FatimaZulfiqarAli-123/arabic_dialect_classification)
...
### 🌐 Smart Multilingual Sentiment Analyzer

A multilingual NLP application for automatic language detection and sentiment classification.
...
[View Repository →](https://github.com/FatimaZulfiqarAli-123/multilingual_sentiment_analyzer)
...
AI-based application designed to assist with research-oriented tasks and academic workflows.

- 📚 Research assistance
- 🤖 AI-powered processing
- 🔎 Academic workflow support
- 🧠 NLP-based functionality

[View Repository →](https://github.com/FatimaZulfiqarAli-123/Research_Paper_Assistant)
...
End-to-end speech processing using **OpenAI Whisper** and **gTTS**.
...
[View Repository →](https://github.com/FatimaZulfiqarAli-123/speech_to_text)
...
Interactive chatbot powered by **Ollama and Streamlit**, enabling conversational AI without relying on cloud APIs.
...
[View Repository →](https://github.com/FatimaZulfiqarAli-123/Streamlit_Ollama_Chatbot)
...
*"Exploring intelligent systems, advancing multilingual NLP, and building responsible AI for the future."* 🚀
